...
const aiDecisionHoldem = async (indicator, survivor, hands, money, pot, is_final, raised, community, choicehistory, languageset) => {
  if (money[indicator] === 0){
    ...
    mention = mention.concat(" You should use all of the strategy available and all the environment including enemies' hands and table moneys. And after give me your decision like 'Fold.' or 'Raise.' or 'Call.', give me your rationale and strategy why you make that decision for 3-4 simple ").concat(languageset).concat(" sentences about the logic including the possibility that a player makes strong hand which is able to beat your hand and the probability, without any special marks. Remember, don't say meaningless mention because you cannot say many words.");
    if (is_final) {
